...
urlpatterns = [
    ...
    path(
        "api/v1/room/<int:room_id>/participants",
    ...
    path(
        ...
        views.update_session_task,
        name="update_session_task",
    ),
    path(
        "api/v1/room/<int:room_id>/history",
        views.get_room_history,
        name="get_room_history",
    ),
    path(
        "api/v1/session/<int:session_id>/results",
        views.get_session_results,
